    ...
    <div className="min-h-screen">
      ...
      <main className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <p>
            Welcome to CodeTimer. These Terms of Service govern your use of our website and application located at
            codetimer.app (the &quot;Service&quot;). By accessing or using the Service, you agree to be bound by these Terms. If
          ...
          <p>
            CodeTimer provides a time tracking tool for developers. You are responsible for maintaining the
            confidentiality of your account and for all activities that occur under your account. You agree to
            immediately notify CodeTimer of any unauthorized use of your account or any other breach of security.
          </p>
          ...
          <ul className="list-disc pl-6 space-y-2">
            ...
            <li>
              To impersonate or attempt to impersonate CodeTimer, a CodeTimer employee, another user, or any other
              person or entity.
            </li>
          ...
          <p>
            ...
            of CodeTimer and its licensors. The Service is protected by copyright, trademark, and other laws of both the
          ...
          <p>
            ...
            for information on how we collect, use, and disclose personal information from our users.
          </p>

          <h2 className="text-2xl font-semibold mt-8 mb-4">5. Limitation of Liability</h2>
          <p>
            In no event shall CodeTimer, nor its directors, employees, partners, agents, suppliers, or affiliates, be
          ...
          <p>If you have any questions about these Terms, please contact us at support@codetimer.app.</p>
        </div>
      </main>
