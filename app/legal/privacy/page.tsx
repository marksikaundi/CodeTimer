    ...
    <div className="min-h-screen">
      ...
      <main className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <p>
            At CodeTimer, we respect your privacy and are committed to
          ...
          <p>
            CodeTimer primarily stores your usage data locally on your device
            using browser local storage. This includes:
          </p>
          ...
          <p>
            ...
            servers unless you explicitly choose to enable cloud synchronization
            features (if available).
          </p>

          <h3 className="text-xl font-semibold mt-6 mb-3">2.2 Usage Data</h3>
          <p>
            We may collect anonymous usage data about how you interact with our
          ...
          <p>
            This data is used for analytics purposes to improve our Service and
          ...
          <p>
            Since most of your data is stored locally on your device, you can
            enhance security by:
          </p>
          <ul className="list-disc pl-6 space-y-2">
          ...
          <p>
            ...
            anonymous unique identifier. CodeTimer uses cookies and similar
          ...
          <ul className="list-disc pl-6 space-y-2">
            ...
            <li>
              The right to object - the right to object to our processing of
              your personal data
            </li>
            <li>
            ...
            <li>
              The right to withdraw consent - the right to withdraw your consent
              at any time where we relied on your consent to process your
              personal information
            </li>
          </ul>
          <p>
            Since most data is stored locally on your device, you can exercise
            many of these rights by clearing your browser&quot;s local storage
            or by using the controls within the application.
          </p>
